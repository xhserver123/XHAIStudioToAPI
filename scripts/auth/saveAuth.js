...
const CONFIG_DIR = "data/configs/auth"; // Authentication files directory
...
/**
 * Gets the next available authentication file index from the 'data/configs/auth' directory.
